...
Quest Quark это минималистичное kanban-приложение для личного и командного управления задачами. Проект построен на Laravel + Inertia.js + React и делает упор на чистый интерфейс, быстрые действия и обновления досок.
